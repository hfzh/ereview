                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="dropdown active">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false"> Manage Assigned Task <i class="fa fa-angle-down"></i> </a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url() . 'index.php/manageassignedtask/confirm_task' ?>">Confirm Task</a></li>
                                <li><a href="<?php echo base_url() . 'index.php/manageassignedtask/submit_review' ?>">Submit Review</a></li>
                                <li><a href="<?php echo base_url() . 'index.php/manageassignedtask/withdraw_funds' ?>">Withdraw Funds</a></li>
                            </ul>
						</li>
